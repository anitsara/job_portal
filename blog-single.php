...
$id = $_GET['id'];
$sql1="SELECT * FROM all_jobs WHERE job_id = '$id'";
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <form action="apply_job.php" enctype="multipart/form-data" name="jobportal" id="jobportal" method="POST">
                <div style="padding: 2%;">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="mob" placeholder="Enter Contact Number..." maxlength="10" required>
                </div>
                ...
                <br>
                    <input type="submit" name="submit" value="Submit" class="btn-block btn btn-primary"> 
                </div>
            </form>
