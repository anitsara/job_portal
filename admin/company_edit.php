            ...
            <div style="width: 60%; margin-left:20%; background-color:#F2F4F4; ">
                ...
                <div id="msg"></div>
                    ...
                    <input type="text" name="company_name" id="company_name" class="form-control"
                           placeholder="Enter Company Name" required value="<?php echo $company_name ?>">
                    </div>
                <div class="form-group">
...
$query1=mysqli_query($con,"UPDATE company SET company ='$company_name', des='$des',admin='$admin' WHERE company_id = '$id'");
if($query1){
