...
include('connection/conn.php');
 include('include/header.php');
  ...
  $query = mysqli_query($con, "SELECT * FROM all_jobs");
          ...
          ?>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="btn-group">
                            <a href="job_edit.php?edit=<?php echo $row['job_id']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" style="font-size:10px;"></span></a>
