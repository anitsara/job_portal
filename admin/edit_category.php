            ...
            <div style="width: 60%; margin-left:20%; background-color:#F2F4F4; ">
                ...
                <div id="msg"></div>
                    ...
                    <input type="text" name="category_name" id="category_name" class="form-control"
                           placeholder="Enter Category Name" value="<?php echo $category; ?>" required>
                    </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" id="description" class="form-control" cols="30" rows="10" required><?php echo $des ?></textarea>   
                </div>
...
$query1=mysqli_query($con,"UPDATE job_category SET category ='$category_name', des='$des' WHERE id = '$id'");
if($query1){
